...
const PageNotification = ({ notisMessage, type }) => {
  return (
    <div className={`${notisMessage ? "": "hidden"} absolute bottom-2 md:bottom-12 lg:bottom-6 left-0 right-0 mx-auto w-fit z-50 flex items-center gap-x-1 md:gap-x-3 lg:gap-x-2 p-3 md:p-5 lg:p-4 bg-grey-dark rounded-xl`}>
