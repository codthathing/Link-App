...
const LogoText = ({style, className, onClick}) => {
  return (
    <nav onClick={onClick} className={`flex ${className} cursor-pointer md:p-0 items-center md:justify-center gap-x-2 md:gap-x-5 lg:gap-x-2`}>
