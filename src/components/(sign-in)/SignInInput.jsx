  ...
  return (
    <div>
      ...
      <main className="border border-grey-semilight flex items-center gap-x-2 p-3 md:p-5 rounded-md md:rounded-lg">
        ...
        <input type={type} id={id} name={name} value={value} onChange={onChange} className="w-full outline-none shadow-inset shadow-grey-light md:shadow-white text-grey-dark text-[8px] md:text-base lg:text-xs" placeholder={placeholder} />
