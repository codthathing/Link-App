...
const SignInInput = ({label, id, type, name, value, onChange, placeholder, errorMessage}) => {
  return (
    <div>
      ...
      <main className={`border ${errorMessage ? "border-customRed" : "border-grey-semilight"} flex items-center gap-x-2 py-1 px-3 md:px-5 md:py-2 rounded-md md:rounded-lg`}>
